...
namespace Biziwe.UI
{
    ...
    /// Phase 1 — mobile-first, this is how the game is actually meant to be played.
    ///
    /// SETUP:
    ...
    ///    Handbrake. Use EventTrigger components (PointerDown/PointerUp) or Button
    ///    OnClick for taps.
    /// 4. Drag this script onto an empty "TouchInputManager" GameObject, assign the
    ///    player and (when in a vehicle) the active VehicleController.
    /// </summary>
